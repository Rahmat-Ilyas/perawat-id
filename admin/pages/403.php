                    ...
                    <div class="account-pages">
                        <div class="account-box">
                            ...
                            <div class="account-content text-center">
                                ...
                                <h4 class="text-uppercase text-danger mt-3">Page Cant Not Access</h4>
                                <p class="text-muted mt-3">It's looking like you may have taken a wrong turn. Don't worry... it
                                    happens to the best of us. Here's a
                                little tip that might help you get back on track.</p>

                                <a class="btn btn-md btn-block btn-gradient waves-effect waves-light mt-3" href="<?= url('home') ?>"> Return Home</a>
                            </div>
                        </div>
                    </div>
                    <!-- end card-box-->
